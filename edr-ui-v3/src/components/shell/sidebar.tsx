...
const NAV: NavGroup[] = [
  {
    ...
    items: [
      ...
      { href: "/incidents",    icon: Layers,          label: "Incidents",  matchPrefix: "/incidents" },
      { href: "/cases",        icon: FolderOpen,      label: "Cases",      matchPrefix: "/cases" },
      { href: "/agents",       icon: Server,          label: "Agents",     matchPrefix: "/agents" },
      { href: "/agent-groups", icon: Users,           label: "Agent Groups" },
    ],
  },
  {
    label: "Investigate",
    items: [
      ...
      { href: "/browser/policy",  icon: ShieldCheck, label: "Browser Policy" },
      { href: "/browser/history", icon: BookMarked,  label: "Browser History" },
      { href: "/usb",             icon: Usb,         label: "USB Devices" },
      { href: "/email-threats",   icon: Mail,        label: "Email Threats" },
      { href: "/hunt",            icon: Crosshair,   label: "Hunt" },
  ...
  },
  {
    label: "Intel",
    items: [
      { href: "/intel/dashboard",     icon: LayoutDashboard, label: "Dashboard",     matchPrefix: "/intel/dashboard" },
      { href: "/intel/actors",        icon: Users,           label: "Actors",        matchPrefix: "/intel/actors" },
      { href: "/intel/campaigns",     icon: Flag,            label: "Campaigns",     matchPrefix: "/intel/campaigns" },
      { href: "/intel/replay",        icon: RotateCcw,       label: "Replay",        matchPrefix: "/intel/replay" },
      { href: "/intel/sharing",       icon: Share2,          label: "Sharing",       matchPrefix: "/intel/sharing" },
      { href: "/intel/tasks",         icon: Zap,             label: "Tasking",       matchPrefix: "/intel/tasks" },
      { href: "/intel/hunt-schedules",icon: CalendarClock,   label: "Hunt Schedules",matchPrefix: "/intel/hunt-schedules" },
      { href: "/intel/taxii",         icon: Rss,             label: "TAXII Feeds",   matchPrefix: "/intel/taxii" },
      { href: "/tip",                 icon: Link2,           label: "TIP Integration" },
    ],
  },
  {
    label: "Detect",
    items: [
      ...
      { href: "/suppressions",    icon: ShieldOff,      label: "Suppressions" },
      { href: "/iocs",            icon: Database,       label: "IOCs" },
      { href: "/ioc-feeds",       icon: Rss,            label: "IOC Feeds" },
      { href: "/dns",             icon: Wifi,           label: "DNS Intelligence" },
      { href: "/vulnerabilities", icon: Bug,            label: "Vulnerabilities" },
      { href: "/mitre-heatmap",   icon: LayoutGrid,     label: "MITRE Heatmap" },
    ],
  },
  {
    label: "XDR",
    items: [
      ...
      { href: "/host-risk",       icon: TrendingUp,      label: "Host Risk" },
      { href: "/posture",         icon: Gauge,           label: "Posture Score" },
      { href: "/threat-score",    icon: ShieldAlert,     label: "Threat Score" },
      { href: "/ueba",            icon: GitBranch,       label: "UEBA Timeline" },
      { href: "/lateral-graph",   icon: GitFork,         label: "Lateral Graph" },
      { href: "/anomalies",       icon: Activity,        label: "Anomalies" },
      { href: "/attack-surface",  icon: ScanSearch,      label: "Attack Surface" },
      { href: "/asset-inventory", icon: Server,          label: "Asset Inventory" },
      { href: "/containers",      icon: Box,             label: "Containers",      matchPrefix: "/containers" },
      { href: "/data-exfil",      icon: ArrowUpFromLine, label: "Data Exfiltration" },
    ],
  },
  {
    label: "Operate",
    items: [
      ...
      { href: "/canary",           icon: Ghost,             label: "Canary Tokens" },
      { href: "/deception",        icon: Crosshair,         label: "Deception Network" },
      { href: "/scheduled-tasks",  icon: CalendarClock,     label: "Scheduled Tasks" },
      { href: "/autocase",         icon: FolderCog,         label: "Auto-Case Policies" },
