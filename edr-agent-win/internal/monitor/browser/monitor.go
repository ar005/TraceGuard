...
// Browser monitor for Windows — receives web request events from the TraceGuard
// browser extension (Chrome/Firefox) via a localhost-only HTTP endpoint.
//
...
//
// Identical implementation to the Linux agent browser monitor.
